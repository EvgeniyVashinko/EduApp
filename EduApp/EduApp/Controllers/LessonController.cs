...
namespace EduApp.Controllers
{
    ...
    public class LessonController : ControllerBase
    {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> RemoveCourse([FromRoute] RemoveLessonRequest request)
        {
            try
            {
        ...
        [HttpPost("Update/{id}")]
        public async Task<IActionResult> UpdateCourse([FromBody] UpdateLessonRequest request)
        {
            try
            {
